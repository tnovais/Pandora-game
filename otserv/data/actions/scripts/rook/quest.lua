...
-----
-- Hell Key --
elseif item.uid == 7099 then
	if getPlayerStorageValue(cid,7099) <= 0 then
		if getPlayerFreeCap(cid) <= 7 then
		doPlayerSendTextMessage(cid,22,"You need 7 cap or more to loot this!")
		return TRUE
		end
	doPlayerSendTextMessage(cid,22,"You have found a key of the hell.")
	HELLROOMKEY = doPlayerAddItem(cid, 2089, 1)
	doSetItemActionId(HELLROOMKEY, 2099)
	doSetItemSpecialDescription(HELLROOMKEY, "(Key: 0666)")
	setPlayerStorageValue(cid,7099,1)
...
elseif item.uid == 7098 then
	if getPlayerStorageValue(cid,7098) <= 0 then
		if getPlayerFreeCap(cid) <= 7 then
		doPlayerSendTextMessage(cid,22,"You need 7 cap or more to loot this!")
		return TRUE
		end
	doPlayerSendTextMessage(cid,22,"You have found a key of the Mino.")
	MINOKEY = doPlayerAddItem(cid, 2089, 1)
	doSetItemActionId(MINOKEY, 2098)
	doSetItemSpecialDescription(MINOKEY, "(Key: 0600)")
...
elseif item.uid == 7097 then
	if getPlayerStorageValue(cid,7097) <= 0 then
		if getPlayerFreeCap(cid) <= 7 then
		doPlayerSendTextMessage(cid,22,"You need 7 cap or more to loot this!")
		return TRUE
		end
	doPlayerSendTextMessage(cid,22,"You have found a key of the hell Room.")
	HELLROOM = doPlayerAddItem(cid, 2089, 1)
	doSetItemActionId(HELLROOM, 2097)
	doSetItemSpecialDescription(HELLROOM, "(Key: 0500)")
